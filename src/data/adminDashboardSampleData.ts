...
export const ADMIN_RECENT_ATTEMPTS: AdminRecentAttempt[] = [
  {
    ...
    course: 'SSC CGL — Quantitative Aptitude',
    test: 'SSC CGL Quant — Full Length Mock',
    score: 78,
    total: 100,
    percentage: 78,
    mode: 'mock',
  ...
  },
  {
    ...
    course: 'SSC — General Science',
    test: 'General Science — Motion & Force',
    score: 19,
    total: 25,
    percentage: 76,
    mode: 'practice',
  ...
  },
  {
    ...
    course: 'UPSC — General Studies (Polity & History)',
    test: 'UPSC General Studies — Full Length Mock',
    score: 65,
    total: 80,
    percentage: 81,
    mode: 'mock',
  ...
  },
  {
    ...
    course: 'IBPS Banking — English Language',
    test: 'English Language — Reading Comprehension',
    score: 14,
    total: 25,
    percentage: 56,
    mode: 'practice',
  ...
  },
  {
    ...
    course: 'SSC CGL — Advanced Maths',
    test: 'Advanced Maths — Algebra & Equations',
    score: 22,
    total: 25,
    percentage: 88,
    mode: 'practice',
  ...
  },
  {
    ...
    course: 'SSC — General Science',
    test: 'General Science — Human Physiology & Nutrition',
    score: 21,
    total: 30,
    percentage: 70,
    mode: 'practice',
  ...
  },
  {
    ...
    course: 'RRB — General Science',
    test: 'General Science — Life Processes & Human Body',
    score: 16,
    total: 20,
    percentage: 80,
    mode: 'practice',
  ...
  },
  {
    ...
    course: 'SSC CGL — Quantitative Aptitude',
    test: 'Quantitative Aptitude — Averages, Time & Work',
    score: 12,
    total: 20,
    percentage: 60,
    mode: 'practice',
...
export const TOP_COURSES: TopCourse[] = [
  { course_id: 'crs_ca_foundation', name: 'SSC CGL — Quantitative Aptitude', attempts: 487, avg_score: 71 },
  { course_id: 'crs_ca_inter', name: 'SSC — General Science', attempts: 392, avg_score: 67 },
  { course_id: 'crs_gst', name: 'UPSC — General Studies (Polity & History)', attempts: 268, avg_score: 74 },
  { course_id: 'crs_ca_final', name: 'IBPS Banking — English Language', attempts: 156, avg_score: 62 },
  { course_id: 'crs_income_tax', name: 'SSC CGL — Advanced Maths', attempts: 211, avg_score: 69 },
];
