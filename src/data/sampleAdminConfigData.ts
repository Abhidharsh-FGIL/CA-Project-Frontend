...
SAMPLE_ADMIN_COURSES.push(
  {
    ...
    name: 'IICA — Insolvency & Bankruptcy',
    description: 'Coverage of IBC 2016, resolution professional standards, and case law analysis.',
  ...
  },
  {
    ...
    name: 'CS Executive (Legacy)',
    description: 'Older syllabus for Company Secretary Executive — archived in favour of new course.',
...
export const SAMPLE_ADMIN_PROMO_CODES: AdminPromoCode[] = [
  {
    code_id: 'pc_001',
    code_string: 'CAFOUND26',
    scope: 'test',
    test_id: 'test_found_mock_2',
    test_name: 'CA Foundation — Paper 2 Mock',
    discount_pct: 100,
    max_uses: 500,
    used_count: 138,
  ...
  {
    code_id: 'pc_002',
    code_string: 'CAINTER26',
    scope: 'test',
    test_id: 'test_inter_mock_1',
    test_name: 'CA Inter — Group I Full Mock',
    discount_pct: 50,
    max_uses: 1000,
    used_count: 423,
  ...
  },
  {
    ...
    test_name: 'GST — Composition & Returns Mock',
    discount_pct: 25,
    max_uses: null,
    used_count: 1247,
  ...
  {
    code_id: 'pc_009',
    code_string: 'AUDIT2026',
    scope: 'test',
    test_id: 'test_audit_prac_3',
    test_name: 'Audit & Assurance Practice',
    discount_pct: 100,
    max_uses: 200,
    used_count: 12,
...
export const SAMPLE_AUDIT_LOG: AuditLogEntry[] = [
  {
    ...
    actor_email: 'admin@fgil.com',
    actor_role: 'super_admin',
    action: 'test_publish',
    resource_type: 'test',
    resource_id: 'test_inter_mock_4',
    resource_name: 'CA Inter — Cost & Management Mock',
    description: 'Published mock test for CA Inter Group I',
  ...
  },
  {
    ...
    resource_name: '12 questions on GST Composition Scheme',
    description: 'AI-generated 12 MCQ + 3 A&R on GST',
    ip_address: '103.84.21.118',
  ...
  },
  {
    ...
    actor_email: 'priya.creator@fgil.com',
    actor_role: 'content_admin',
    action: 'paper_create',
    resource_type: 'paper',
    resource_id: 'paper_2026_018',
    resource_name: 'CA Final Direct Tax — Full Paper',
  ...
  },
  {
    ...
    resource_type: 'promo',
    resource_id: 'pc_009',
    resource_name: 'AUDIT2026',
    description: 'Created 100% promo for Audit & Assurance Practice test',
    ip_address: '103.84.21.118',
  ...
  },
  {
    ...
    resource_name: 'Income Tax — Section 80C deductions',
  ...
  },
  {
    ...
    resource_name: 'Outdated FM question',
    description: 'Removed outdated working-capital question (FM syllabus update)',
    ip_address: '49.207.215.42',
  ...
  },
  {
    ...
    resource_name: 'IICA — Insolvency & Bankruptcy',
  ...
  },
  {
    ...
    resource_name: 'Legacy 2025 CA Inter Mock',
  ...
  },
  {
    ...
    resource_name: 'CS Executive (Legacy)',
    description: 'Archived legacy CS Executive course',
    ip_address: '103.84.21.118',
